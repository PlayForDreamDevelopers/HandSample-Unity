...
namespace YVR.Interaction.Runtime
{
    ...
    public class YVRAimHand : TrackedDevice
    {
        ...
        {
            UpdateAim(isLeft, out var aimFlags, out var aimPosePosition, out var aimPoseRotation, out var pinchIndex,
                      out var pinchMiddle, out var pinchRing, out var pinchLittle);

            UpdateHand(aimFlags, new Pose(aimPosePosition, aimPoseRotation),
